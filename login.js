...
loginButton.addEventListener("click", function (e) {
  ...
  console.log("Chuyển hướng đến menu.html"); // Kiểm tra trong console
  setTimeout(function () {
    window.location.href = "menu.html"; // Chuyển hướng sau 1 giây
  }, 1000);
});
...
registerButton.addEventListener("click", function (e) {
  ...
  console.log(firstName, lastName, email, password); // Kiểm tra giá trị của các trường
  ...
  const isNameValid = namePattern.test(firstName) && namePattern.test(lastName);
  ...
  console.log(isNameValid, isEmailValid, isPasswordValid); // Kiểm tra các điều kiện hợp lệ
